...
const Footer = () => (
  <div id={styles.footer}>
    <div id={styles.colOne}>
      <div className={styles.giftCard}>GIFT CARDS</div>
      <div className={styles.promotion}>PROMOTIONS</div>
      <div className={styles.findStore}>FIND A STORE</div>
      <div className={styles.signUp}>SIGN UP FOR EMAIL</div>
      <div className={styles.membership}>BECOME A MEMBER</div>
      <div className={styles.journal}>NIKE JOURNAL</div>
      <div className={styles.feedback}>SEND US FEEDBACK</div>
    </div>
    <div id={styles.colTwo}>
      <div className={styles.assistance}>GET HELP</div>
      <div className={styles.status}>Order Status</div>
      <div className={styles.shipping}>Shipping and Delivery</div>
      <div className={styles.returns}>Returns</div>
      <div className={styles.payment}>Payment Options</div>
      <div className={styles.cardBalance}>Gift Card Balance</div>
      <div className={styles.contact}>Contact Us</div>
    </div>
    <div id={styles.colThree}>
      <div className={styles.about}>ABOUT NIKE</div>
      ...
      <div className={styles.chainsAct}>CA Supply Chains Act</div>
    </div>
    <svg className={styles.twitter} width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
    ...
    <svg className={styles.facebook} width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
    ...
    <svg className={styles.youtube} width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
    ...
    <svg className={styles.instagram} width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
